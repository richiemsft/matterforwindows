...
/**
 *  @def CHIP_SYSTEM_CONFIG_WINDOWS_LOCKING
 *
 *  @brief
 *      Use native Windows locking primitives.
 */
#ifndef CHIP_SYSTEM_CONFIG_WINDOWS_LOCKING
#if defined(_WIN32)
#define CHIP_SYSTEM_CONFIG_WINDOWS_LOCKING 1
#else
#define CHIP_SYSTEM_CONFIG_WINDOWS_LOCKING 0
#endif
...
#if (CHIP_SYSTEM_CONFIG_POSIX_LOCKING + CHIP_SYSTEM_CONFIG_WINDOWS_LOCKING + CHIP_SYSTEM_CONFIG_FREERTOS_LOCKING +              \
     CHIP_SYSTEM_CONFIG_MBED_LOCKING + CHIP_SYSTEM_CONFIG_CMSIS_RTOS_LOCKING + CHIP_SYSTEM_CONFIG_ZEPHYR_LOCKING +             \
     CHIP_SYSTEM_CONFIG_NO_LOCKING) != 1
#error "Exactly one System locking implementation must be selected"
#endif

#if CHIP_SYSTEM_CONFIG_POSIX_LOCKING && (CHIP_SYSTEM_CONFIG_WINDOWS_LOCKING || CHIP_SYSTEM_CONFIG_FREERTOS_LOCKING || CHIP_SYSTEM_CONFIG_MBED_LOCKING || CHIP_SYSTEM_CONFIG_CMSIS_RTOS_LOCKING || CHIP_SYSTEM_CONFIG_ZEPHYR_LOCKING || CHIP_SYSTEM_CONFIG_NO_LOCKING)
...
#if CHIP_SYSTEM_CONFIG_WINDOWS_LOCKING && (CHIP_SYSTEM_CONFIG_FREERTOS_LOCKING || CHIP_SYSTEM_CONFIG_MBED_LOCKING || CHIP_SYSTEM_CONFIG_CMSIS_RTOS_LOCKING || CHIP_SYSTEM_CONFIG_ZEPHYR_LOCKING || CHIP_SYSTEM_CONFIG_NO_LOCKING)
#error "FORBIDDEN: CHIP_SYSTEM_CONFIG_WINDOWS_LOCKING with another locking implementation"
#endif
...
#if (CHIP_SYSTEM_CONFIG_USE_SOCKETS || CHIP_SYSTEM_CONFIG_USE_NETWORK_FRAMEWORK) && !defined(__ZEPHYR__) && !defined(_WIN32)
